          ...
          <div className="w-full md:w-5/12 space-y-8 flex flex-col">
            ...
            <div className="space-y-6 text-stone-700 flex-grow">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-bold uppercase text-sm mb-1">{t("address_label")}</p>
                  <p className="text-sm">{t("address_value")}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-bold uppercase text-sm mb-1">{t("phone_label")}</p>
                  <p className="text-sm font-medium">{t("phone_value")}</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-bold uppercase text-sm mb-1">{t("email_label")}</p>
                  <p className="text-sm font-medium">{t("email_value")}</p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-7/12 flex flex-col">
            <div className="bg-stone-50 p-2 rounded-2xl shadow-inner border border-stone-100 h-full min-h-[450px] relative group">
              ...
              <div className="absolute top-6 left-6 z-10 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-md border border-amber-100 flex items-center gap-2">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-stone-800">{t("find_us")}</span>
              </div>
